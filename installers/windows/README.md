...
**Process-local PATH only** — Text-seeker prepends private/runtime paths when launching. Windows user/system PATH is **not** modified unless you explicitly choose that in the installer.

Optional: **`Add-Tools-To-User-Path.bat`** (legacy opt-in helper; not run automatically).
